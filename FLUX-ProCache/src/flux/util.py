...
configs = {
    "flux-dev": ModelSpec(
        repo_id="/hpc2hdd/home/fcao628/models/FLUX.1-dev",
        repo_flow="flux1-dev.safetensors",
        repo_ae="ae.safetensors",
        ckpt_path="/hpc2hdd/home/fcao628/models/FLUX.1-dev/flux1-dev.safetensors",
        lora_path=None,
        params=FluxParams(
            in_channels=64,
            out_channels=64,
        ...
        ae_path="/hpc2hdd/home/fcao628/models/FLUX.1-dev/ae.safetensors",
        ae_params=AutoEncoderParams(
            resolution=256,
            in_channels=3,
            ch=128,
    ...
    "flux-schnell": ModelSpec(
        repo_id="/hpc2hdd/home/fcao628/models/FLUX.1-schnell",
        repo_flow="flux1-schnell.safetensors",
        repo_ae="ae.safetensors",
        ckpt_path="/hpc2hdd/home/fcao628/models/FLUX.1-schnell/flux1-schnell.safetensors",
        lora_path=None,
        params=FluxParams(
            in_channels=64,
            out_channels=64,
        ...
        ae_path="/hpc2hdd/home/fcao628/models/FLUX.1-schnell/ae.safetensors",
        ae_params=AutoEncoderParams(
            resolution=256,
            in_channels=3,
            ch=128,
...
def load_flow_model(
    name: str, device: str | torch.device = "cuda", hf_download: bool = False, verbose: bool = False
) -> Flux:
    # Loading Flux
    print("Init model")
...
def load_t5(device: str | torch.device = "cuda", max_length: int = 512) -> HFEmbedder:
    ...
    return HFEmbedder("/hpc2hdd/home/fcao628/models/t5-v1_1-xxl", max_length=max_length, torch_dtype=torch.bfloat16).to(device)
    # return HFEmbedder("google/t5-v1_1-xxl", max_length=max_length, torch_dtype=torch.bfloat16).to(device)

def load_clip(device: str | torch.device = "cuda") -> HFEmbedder:
    return HFEmbedder("/hpc2hdd/home/fcao628/models/clip-vit-large-patch14", max_length=77, torch_dtype=torch.bfloat16).to(device)
    # return HFEmbedder("openai/clip-vit-large-patch14", max_length=77, torch_dtype=torch.bfloat16).to(device)

def load_ae(name: str, device: str | torch.device = "cuda", hf_download: bool = False) -> AutoEncoder:
