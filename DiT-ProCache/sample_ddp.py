...
def main(args):
    ...
    ckpt_path = args.ckpt or f"/hpc2hdd/home/fcao628/models/DiT-XL-2-{args.image_size}x{args.image_size}.pt"
    state_dict = find_model(ckpt_path)
    model.load_state_dict(state_dict)
    model.eval()  # important!
    diffusion = create_diffusion(str(args.num_sampling_steps))
    vae = AutoencoderKL.from_pretrained(f"/hpc2hdd/home/fcao628/models/sd-vae-ft-{args.vae}").to(device)
    ...
    folder_name = f"ProCache-{model_string_name}-{ckpt_string_name}-size-{args.image_size}-vae-{args.vae}-" \
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-dir", type=str, default="/hpc2hdd/home/fcao628/output/samples") # Change this to your desired sample directory
    ...
    parser.add_argument("--cache-type", type=str, choices=['random', 'attention','similarity','norm', 'compress','kv-norm'], default='attention') # only attention supported currently
